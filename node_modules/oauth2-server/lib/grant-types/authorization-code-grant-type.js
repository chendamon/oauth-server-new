...
AuthorizationCodeGrantType.prototype.getAuthorizationCode = function(request, client) {
  ...
  return promisify(this.model.getAuthorizationCode, 1).call(this.model, request.body.code)
    .then(function(code) {
      if (!code) {
        throw new InvalidGrantError('Invalid grant: authorization code is invalid code null',code);
      }
      ...
      if (code.client.clientId !== client.clientId) {
        throw new InvalidGrantError('Invalid grant: authorization code is invalid clientid');
      }
...
AuthorizationCodeGrantType.prototype.revokeAuthorizationCode = function(code) {
  return promisify(this.model.revokeAuthorizationCode, 1).call(this.model, code)
    .then(function(status) {
      if (!status) {
        throw new InvalidGrantError('Invalid grant: authorization code is invalid revoke');
      }
